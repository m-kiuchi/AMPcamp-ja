...
2. データの中身を見てみましょう。RDDのtake操作を使って初めの2個のRDDを見ていきます。
...
4.[SparkSQL](spark-sql.md)の練習を思い出してみてください。このデータの構成も似ている(pageId, title, modifiedTime, text, username)ことがわかります。
...
6. もう少し面白いことをしましょう。データセットを探索し、ユーザーが貢献した数のヒストグラムを作りましょう。
...
7. 応用的な実践として、上のコードを使って以下の課題を解いてみてください。

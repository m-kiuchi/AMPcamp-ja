...
これでGraphXのチュートリアルの章は終わりです。このままコードを触り続けることと[GraphXのプログラミングガイド](http://spark.incubator.apache.org/docs/latest/graphx-programming-guide.html)をこのシステムの補足としてチェックすることをお勧めします。
